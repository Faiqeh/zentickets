            ...
            <div class="row"></div>
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Mengubah Penerbangan</li>
                    </ol>
                    
                    <h1 class="h2">Mengubah Penerbangan</h1>
                        ...
                        <div class="col-12 col-xl-12 mb-4 mb-lg-0">
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                        $id = $_GET['id'];
                                        $select_flights = mysqli_query($c, "SELECT * FROM flights INNER JOIN planes ON planes.plane_id=flights.flight_plane WHERE flight_id='$id'");
                                    ...
                                    <form method="post">
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$flight_no;?>" name="flight_no" required>
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="flight_plane" required>
                                                        ...
                                                        <option value="<?=$flight_plane;?>" selected><?=$plane_no;?></option>
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$flight_gate;?>" name="flight_gate" required>
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="flight_arr" required>
                                                        ...
                                                        <option value="<?=$flight_arr;?>" selected><?=$flight_arr;?></option>
                                                        <option value="" disabled>---------</option>
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="flight_dep" required>
                                                        ...
                                                        <option value="<?=$flight_dep;?>" selected><?=$flight_dep;?></option>
                                                        <option value="" disabled>---------</option>
                                                        <option value="Tangerang">Tangerang</option>
                                                        <option value="Semarang">Semarang</option>
                                                        <option value="Surabaya">Surabaya</option>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="datetime-local" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$flight_takeoff;?>" name="flight_takeoff" required>
                                                    <label for="floatingInput">Take Off</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="datetime-local" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$flight_landing;?>" name="flight_landing" required>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="flight_class" required>
                                                        ...
                                                        <option value="<?=$flight_class;?>" selected><?=$flight_class;?></option>
                                                        <option value="" disabled>---------</option>
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$flight_price;?>" name="flight_price" required>
                                                    <label for="floatingInput">Harga</label>
                                                </div>
                                            </div>
                                        </div>
                                        <input type="hidden" name="flight_id" value="<?=$flight_id;?>">
                                        <button type="submit" class="btn btn-primary" name="flight_edit">Simpan</button>
                                    </form>
