            ...
            <div class="row"></div>
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Melihat Penerbangan</li>
                    </ol>
                    
                    <h1 class="h2">Melihat Penerbangan</h1>
                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$flight_no;?>" disabled>
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" disabled>
                                                        <option disabled>No. Pesawat</option>
                                                        <option value="" selected><?=$plane_no;?></option>
                                                    </select>
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$flight_gate;?>" disabled>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" disabled>
                                                        <option disabled>Keberangkatan</option>
                                                        <option value="" selected><?=$flight_arr;?></option>
                                                    </select>
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" disabled>
                                                        <option disabled>Tujuan</option>
                                                        <option value=""><?=$flight_dep;?></option>
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="datetime-local" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$flight_takeoff;?>" disabled>
                                                    <label for="floatingInput">Take Off</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="datetime-local" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$flight_landing;?>" disabled>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" disabled>
                                                        ...
                                                        <option value="" selected><?=$flight_class;?></option>
                                                    </select>
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$flight_price;?>" disabled>
