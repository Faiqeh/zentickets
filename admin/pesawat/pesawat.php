            ...
            <div class="row"></div>
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Pesawat</li>
                    </ol>
                    ...
                    <div class="row">
                        <div class="col-12 col-xl-12 mb-4 mb-lg-0">
                            <div class="card">
                                <div class="card-body">
                                    <a href="pesawat_create.php" class="btn btn-sm btn-primary mb-3">Tambah Pesawat</a>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="post">
                                                            <a href="pesawat_read.php?id=<?=$plane_id;?>" class="btn btn-sm btn-primary">Lihat</a>
                                                            <a href="pesawat_edit.php?id=<?=$plane_id;?>" class="btn btn-sm btn-primary">Edit</a>
                                                            <input type="hidden" name="plane_id" value="<?=$plane_id;?>">
                                                            <button type="submit" class="btn btn-sm btn-primary" name="plane_delete">Hapus</button>
                                                        </form>
                                                    </td>
                                                </tr>
