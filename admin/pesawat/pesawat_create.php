            ...
            <div class="row"></div>
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Membuat Pesawat</li>
                    </ol>
                    
                    <h1 class="h2">Membuat Pesawat</h1>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form method="post">
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="plane_no" required>
                                                    <label for="floatingInput">No. Pesawat</label>
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="form-floating mb-3">
                                                    <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com"  name="plane_reg" required>
                                        ...
                                        <button type="submit" class="btn btn-primary" name="plane_create">Simpan</button>
                                    </form>
                                </div>
                            </div>
                        </div>
