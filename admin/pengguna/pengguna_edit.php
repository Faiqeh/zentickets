            ...
            <div class="row"></div>
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Mengubah Pengguna</li>
                    </ol>
                    
                    <h1 class="h2">Mengubah Pengguna</h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="user_name" value="<?=$user_name;?>" required>
                                                <label for="floatingInput">Nama</label>
                                            </div>
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$user_phone;?>" name="user_phone" required>
                                                    <label for="floatingInput">No. HP</label>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="user_sex" required>
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="date" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$user_birth;?>" name="user_birth" required>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$user_email;?>" name="user_email" required>
                                                    <label for="floatingInput">Email</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="password" class="form-control" id="floatingInput" placeholder="name@example.com" value="<?=$user_password;?>" name="user_password" required>
