            ...
            <div class="row"></div>
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Membuat Pengguna</li>
                    </ol>
                    
                    <h1 class="h2">Membuat Pengguna</h1>
                                ...
                                <div class="card-body">
                                    <form method="post">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="user_name" required>
                                                <label for="floatingInput">Nama</label>
                                            </div>
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" placeholder="name@example.com" name="user_phone" required>
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="date" class="form-control" id="floatingInput" placeholder="name@example.com" name="user_birth" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-floating mb-3">
                                                    <input type="password" class="form-control" id="floatingInput" placeholder="name@example.com" name="user_password" required>
                                                    <label for="floatingInput">Password</label>
                                                </div>
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-primary" name="user_create">Simpan</button>
                                    </form>
                                </div>
                            </div>
                        </div>
